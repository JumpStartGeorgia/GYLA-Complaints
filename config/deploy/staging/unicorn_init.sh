...
##### SET THESE VARIABLES ########
##################################
AS_USER=gylacomplaints-staging # name of user on server
APP_ROOT=/home/gylacomplaints-staging/GYLA-Complaints-Staging/current # path to application current folder
