...
set :application, "GYLA-Complaints-Staging" # unique name of application
set :user, "gylacomplaints-staging" # name of user on server
...
set :github_repo_name, "GYLA-Complaints" # name of git hub repo
